...
Before you start coding anything inside these classes, :ref:`diagram <inheritance-diagram>` how the three classes are going to be related 
to each other. 
...
:ref:`Check your solution <inheritance-solution-1>`
...
:ref:`Check your solution <inheritance-solution-2>`

Abstract class design
---------------------
Consider the group of classes that you designed. Suppose you have a web program 
...
#. Add this class to your ``Technology`` project above, and add ``AbstractEntity`` to the class hierarchy in the correct place.

:ref:`Check your solution <inheritance-solution-3>`
